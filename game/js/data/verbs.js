// verbs.js — Italian conjugation engine (ported from italian_game/js/data/verbs.js).
// 62 verbs × 12 tenses/moods; regular -are/-ere/-ire (+isc), irregulars, essere/avere
// auxiliaries with participle agreement.
// ===== Conjugation engine =====
...
export const VERB_LIST = Object.keys(VERB_DATA);
